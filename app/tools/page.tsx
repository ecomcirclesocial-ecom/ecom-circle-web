...
const herramientas = [
  ...
  {
    href: "/tools/calculadora-producto",
    icon: Calculator,
  ...
  {
    href: "/tools/logistica",
    icon: Package,
    nombre: "Dashboard Logístico",
    descripcion: "Sube tu reporte diario de Dropi y visualiza el estado de tus órdenes agrupado en 6 estados.",
    estado: "Disponible",
    featured: false,
  },
  {
    href: "/tools/angulos-venta",
    icon: Target,
